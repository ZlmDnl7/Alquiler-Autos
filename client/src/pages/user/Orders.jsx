...
export default function Orders() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-20">
      ...
      <h1 className="text-4xl font-semibold mb-2">Tus Reservas</h1>
      <div className="text-sm text-gray-600 mb-8">
        {bookings && bookings.length > 0 ? "Revisa todas tus reservas" :  <div className="font-extrabold text-black flex justify-center items-center min-h-[500px]">No hay reservas aún</div>}
      </div>
      <div className="mb-8">
